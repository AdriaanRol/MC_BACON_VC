...
fname ='NV_C011_Raw_Data_' + datetime.datetime.now().strftime("%Y%m%d_%H%M")
...
Gridsize = 25
A_Max = 400e3 #Max Hyperfine interaction strength in Hz
A_Min = 10e3 # Min Hyperfine interaction strength !Allowed to be lower at lower Conc
tau_max= 10e-6 # max resonance time to look for in s !Allowed to be longer if lower Conc
tau_step = 1e-9 #timestep in s , was 2ns nu 1ns beste wat we experimenteel kunnen doen
max_gate_time = 2e-3# choose high because possible to correct in post proc
