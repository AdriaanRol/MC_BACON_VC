...
try:
    ...
    filename = 'simulation_data_werkbespreking/NV_C13_0.011_Raw_Data_20131203_2125'
...
max_gate_time_ls =np.arange(0.5e-3,20e-3,.05e-3) # Minimum Gate Fidelity 2e-3 #max gate time in s was 500e-6 kan hoger van tim (dubbel)!Allowed to be higher lower Conc
F_Min = 0.90
B_Field = 150
